...
<div class="container">
    ...
    <div><a href="${pageContext.request.contextPath}/KhachHang/taoTaiKhoan" class="btn btn-primary">Thêm khách hàng</a>
    </div>
    <br>
    <br>
    <br>
    ...
    <table class="table table-striped">
        ...
        <c:forEach var="kh" items="${listKH}" varStatus="i">
            ...
            <tr  class="product-item hide-row" data-tenKhachHang="${kh.tenKhachHang}" data-email="${kh.email}"  data-soDienThoai="${kh.soDienThoai}" data-diaChi="${kh.diaChi}">
                ...
                <td>${kh.diaChi}</td>
                <td>${kh.ghiChu}</td>
                <td>${kh.trangThai == 1 ? "✔" : "✖"}</td>
                <td>
                    <a href="/KhachHang/edit/${kh.id}" class="btn btn-primary">Edit</a>
                    <a href="/KhachHang/delete/${kh.id}" class="btn btn-danger">Delete</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
