...
<div class="container">
    ...
    <div class="" style="margin-top: 0px; margin-bottom: 20px">
        ...
        <div class="row">
            ...
            <div class="col-2" style="margin-left: 45px">
                <a href="/GiayTheThao/listGiayTheThao" style="text-decoration: none">
                    <button class="button" style="width: 130px;margin-top: 0px; margin-bottom: 20px">
                        <svg class="svg-icon" fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg"><g stroke="#ff342b" stroke-linecap="round" stroke-width="1.5"><path d="m3.33337 10.8333c0 3.6819 2.98477 6.6667 6.66663 6.6667 3.682 0 6.6667-2.9848 6.6667-6.6667 0-3.68188-2.9847-6.66664-6.6667-6.66664-1.29938 0-2.51191.37174-3.5371 1.01468"></path><path d="m7.69867 1.58163-1.44987 3.28435c-.18587.42104.00478.91303.42582 1.0989l3.28438 1.44986"></path></g></svg>
                        <span class="lable">Load lại</span>
                    </button>
                </a>
            </div>
        </div>
        ...
        <div class="row">
            <h3 style="margin-top: 5px; color: black; margin-bottom: 20px">Lọc giày thể thao</h3>
            <div class="col-12">
                    ...
                    <form id="filter-form">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input style="width: 500px; height: 35px;border-radius: 5px 5px 5px" type="text" id="tenGiayTheThao" placeholder="Tên giày ">
                            </div>
                            <div class="col-6">
                                ...
                                <div>
                                    ...
                                    <p style="color: black">Giá tối đa: <span id="maxPrice">300.000.000</span></p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                ...
                                <select style="width: 500px;height: 35px; border-radius: 5px 5px 5px;margin-bottom: 0px" type="text" id="thuongHieu">
                                    <option style="border-radius: 5px 5px 5px;color: gray" value="">Tất cả dữ liệu của thương hiệu</option>
                                    <c:forEach items="${thuongHieu}" var="thuongHieu">
                                        <option style="border-radius: 5px 5px 5px; color: gray">${thuongHieu.tenThuongHieu}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="col-6">
                                ...
                                <select style="width: 500px;height: 35px; border-radius: 5px 5px 5px;margin-bottom: 0px" type="text" id="congDung">
                                    <option style="border-radius: 5px 5px 5px;color: gray" value="">Tất cả dữ liệu của công dụng</option>
                                    <c:forEach items="${congDung}" var="congDung">
                                        <option style="border-radius: 5px 5px 5px; color: gray" >${congDung.tenCongDung}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                ...
                                <select id="trangThai" style="width: 500px;height: 35px; border-radius: 5px 5px 5px">
                                    <option value="" style="color: gray">Tất cả trạng thái ✔✖</option>
                                    <option value="1" style="color: gray">Đã kích hoạt ✔</option>
                                    <option value="0" style="color: gray">Chưa kích hoạt ✖</option>
                                </select>
                            </div>
                        </div>
                        <br>
            ...
            <div class="content-tabs">
                <div class="tab ${param.tab == 'active' ? 'active' : ''}" id="tab1">
                    ...
                    <table style="border-collapse: collapse; width:100%; margin-top: 40px">
                        <thead>
                        <tr>
                            <th scope="col" style="text-align: center;color: black; width: 40px">STT</th>
                            <th scope="col" style="text-align: center;color: black">Tên giầy thể thao</th>
                            <th scope="col" style="text-align: center;color: black">Ảnh</th>
                            ...
                            <th scope="col" style="text-align: center;color: black;width: 225px">Chức năng</th>
                        </tr>
                        </thead>
                        <tbody>
                        <c:forEach var="giayTheThao" items="${listPage}" varStatus="i">
                            <c:if test="${giayTheThao.trangThai eq 1}">
                                <tr>
                                    ...
                                    <td>
                                        <a class="col-sm-4" href="${pageContext.request.contextPath}/GiayTheThao/update/${giayTheThao.id}"><button class="btn btn-primary" >Sửa</button></a>

                                        <a class="col-sm-4" href="${pageContext.request.contextPath}/GiayTheThao/update/${giayTheThao.id}"><button class="btn btn-primary"  >Chi tiết</button></a>
                                    </td>
                                </tr>
                            </c:if>
                        </c:forEach>
                            ...
                            <ul class="pagination" style="margin-left: 400px">
                                <c:choose>
                                    <c:when test="${currentPage > 1}">
                                        <li class="page-item">
                                            <a href="/GiayTheThao/listGiayTheThao?pageNum=${currentPage - 1}&tab=active" class="page-link" style="border: 1px solid red;width: 100px">Trước</a>
                                        </li>
                                    </c:when>
                                    <c:otherwise>
                                ...
                                <c:if test="${currentPage < totalPage}">
                                    <li class="page-item">
                                        <a href="/GiayTheThao/listGiayTheThao?pageNum=${currentPage + 1}&tab=active" class="page-link" style="border: 1px solid red; width: 50px">Sau</a>
                                    </li>
                                </c:if>
                            </ul>
                        </div>
                ...
                <div class="tab ${param.tab == 'inactive' ? 'active' : ''}" id="tab2">
                    ...
                    <table style="border-collapse: collapse; width:100%; margin-top: 40px">
                        ...
                        <tr>
                            ...
                            <th scope="col" style="text-align: center;color: black">Giá bán VNĐ</th>
                            <th scope="col" style="text-align: center;color: black">Thương hiệu</th>
                            <th scope="col" style="text-align: center;color: black">Chức năng</th>
                        </tr>
                        </thead>
                        <tbody>
                        <c:forEach var="giayTheThao" items="${listPage}" varStatus="i">
                            <c:if test="${giayTheThao.trangThai eq 0}">
                                <tr>
                                    ...
                                    <td style="margin-bottom: 10px">
                                        <a class="col-sm-4" href="${pageContext.request.contextPath}/GiayTheThao/update/${giayTheThao.id}"><button class="btn btn-primary" style="margin-left: 30px;float: left; margin-top: 22px">Sửa</button></a>
                                        <a class="col-sm-4" href="${pageContext.request.contextPath}/GiayTheThao/update/${giayTheThao.id}"><button class="btn btn-primary" style="margin-top: 0px">Chi tiết</button></a>
                                    </td>
                                </tr>
                            </c:if>
                        </c:forEach>
                        ...
                        <div class="col-12" style="">
                            <ul class="pagination" style="margin-left: 400px">
                                <c:choose>
                                    <c:when test="${currentPage > 1}">
                                        <li class="page-item">
                                            <a href="/GiayTheThao/listGiayTheThao?pageNum=${currentPage - 1}&tab=inactive" class="page-link" style="border: 1px solid red;width: 100px">Trước</a>
                                        </li>
                                    </c:when>
                                    <c:otherwise>
                                        <!-- Ẩn nút "Previous" khi trang hiện tại là trang đầu tiên -->
                                ...
                                <c:if test="${currentPage < totalPage}">
                                    <li class="page-item">
                                        <a href="/GiayTheThao/listGiayTheThao?pageNum=${currentPage + 1}&tab=inactive" class="page-link" style="border: 1px solid red; width: 50px">Sau</a>
                                    </li>
                                </c:if>
                            </ul>
                        </div>
