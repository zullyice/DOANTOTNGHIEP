...
<head>
    ...
    <title>Thêm dữ liệu giày thể thao</title>
...
<div class="container">
    ...
    <a href="/GiayTheThao/listGiayTheThao" style="text-decoration: none">
        <button style="margin-bottom: 10px;" type="submit" class="btn btn-primary">Quay lại</button>
    </a>

    <h3 style="text-align: center; color: black; margin-top: 0px; margin-bottom: 30px">Thêm dữ liệu sản phẩm</h3>
    ...
    >
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                <label style="color: #0b0b0b">Kiểu dáng giày</label>
            ...
            <div class="form-group col-md-4">
                <label style="color: #0b0b0b">Công dụng giày</label>
                <span style="color: red">*</span>
            ...
            <div class="form-group col-md-4">
                <label style="color: #0b0b0b">Chất liệu giày</label>
                <span style="color: red">*</span>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                <label style="color: #0b0b0b">Hướng dẫn bảo quản </label>
                <span style="color: red">*</span>
            ...
            <div class="form-group col-md-4">
                <label style="color: #0b0b0b">Lót giày</label>
                <span style="color: red">*</span>
            ...
            <div class="form-group col-md-4">
                <label style="color: #0b0b0b">Cổ giày</label>
                <span style="color: red">*</span>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                <label style="color: #0b0b0b">Đế giày</label>
                <span style="color: red">*</span>
            ...
            <div class="form-group col-md-4">
                <label style="color: #0b0b0b">Dây giày</label>
                <span style="color: red">*</span>
            ...
            <div class="form-group col-md-4">
                <label style="color: #0b0b0b">Trọng lượng giày</label>
                <span style="color: red">*</span>
            ...
            <div class="form-group col-md-4">
                <label style="color: #0b0b0b">Thương hiệu giày</label>
                <span style="color: red">*</span>
            ...
            <div class="form-group col-md-4">
                <label style="color: #0b0b0b">Kiểu buộc giày</label>
                <span style="color: red">*</span>
            ...
            <div class="form-group col-md-4">
                <label style="color: #0b0b0b">Đinh tán giày</label>
                <span style="color: red">*</span>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                <label style="color: #0b0b0b">Tên giày</label>
                <span style="color: red">*</span>
                <frm:input id="tenGiayTheThao" required="" type="text" class="form-control" path="tenGiayTheThao" cssStyle="" placeholder="Nhập tên giày" value=""/>
            ...
            <div class="form-group col-md-4">
                <label style="color: #0b0b0b">Giá bán VNĐ</label>
                <span style="color: red">*</span>
                <frm:input id="giaBan"  required="" type="text" class="form-control" path="giaBan" cssStyle="" onblur="formatGiaBan()" placeholder="nhập giá sản phẩm: VNĐ" value=""/>
            ...
            <div class="form-group col-md-4">
                <label style="margin-left: 30px; color: #0b0b0b ">Giới tính :</label>
