...
<head>
    ...
    <title>Sửa dữ liệu giầy thể thao</title>
        ...
        <div class="row">
            <div class="col-3">
                <a href="/GiayTheThao/listGiayTheThao" style="text-decoration: none">
                    <button style="margin-bottom: 30px;" type="submit" class="btn btn-primary">Quay lại</button>
                </a>
            </div>
<%--            <div class="col-lg-12">--%>
<%--                <marquee>--%>
...
<%--            </div>--%>
    ...
    <div class="container">
        <h3 style="text-align: center;color: black; margin-top: 40px; margin-bottom: 30px">Thêm giày thể thao chi tiết (Màu sắc , Kích cỡ, Số lượng)</h3>
        <div class="mess">
