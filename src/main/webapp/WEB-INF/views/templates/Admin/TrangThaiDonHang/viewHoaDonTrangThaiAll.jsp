...
<div class="container">
    ...
    <div class="vertical-menu" style="background-color: #bac8f3">
        <a href="/Admin/xacNhanDonHangKhachHangAll" style="color: black">Tất cả trạng thái đơn hàng</a>
   ...
   <br>
    <div style="overflow-x: auto;width: 100%">
        <h3 style="text-align: center;color: black;margin-bottom: 50px;margin-top: 10px">Tất cả trạng thái các đơn hàng</h3>
...
<%--                    <td scope="col" style="color: black;font-weight: bold;font-size: 17px;text-align: center;background-color: #bac8f3;width: 300px">Ghi chú</td>--%>
                    ...
                    <td scope="col" style="color: black;font-weight: bold;font-size: 17px;background-color: #bac8f3;width: 130px">Chức năng</td>
