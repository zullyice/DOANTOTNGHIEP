...
<head>
    ...
    <title>Easy-Shop Trang Chủ Admin</title>
        ...
        <div class="row">
                <div class="col-12">
                    <marquee>
                        ...
                        <div style="font-size: 50px; font-weight: bold; font-family: Brush Script MT ; color: #bac8f3;">Website bán giày Sneaker Easy-Shop</div>
