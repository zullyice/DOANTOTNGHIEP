...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
            ...
            <div class="sidebar-brand-text mx-3">Easy-Shop</div>
        </a>
        <!-- Divider -->
        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="/GiayTheThao/listGiayTheThao">Giầy Sneaker</a>
                    <div class="collapse-divider"></div>
                    <h4 class="collapse-header" style="color: black; font-weight: bold; font-size: 15px">Các trang khác:</h4>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <div class="collapse-divider"></div>
                    <h6 class="collapse-header">Người dùng khác:</h6>
                    ...
                    <li class="nav-item dropdown no-arrow mx-1">
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                ...
                                <div>
                                    <div class="small text-gray-500">Ngày 12 tháng 11 năm 2019</div>
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                ...
                                <div class="font-weight-bold">
                                    <div class="text-truncate">Chào bạn! Tôi đang tự hỏi liệu bạn có thể giúp tôi một việc không
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                ...
                                <div>
                                    <div class="text-truncate">Tôi có những bức ảnh mà bạn đặt hàng tháng trước, làm thế nào
                                        bạn có muốn chúng được gửi cho bạn không?
                                    </div>
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                ...
                                <div>
                                    <div class="text-truncate">Báo cáo tháng trước có vẻ tuyệt vời, tôi rất hài lòng với
                                        tiến độ cho đến nay, hãy tiếp tục phát huy nhé!
                                    </div>
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                ...
                                <div>
                                    <div class="text-truncate">Tôi có phải là một chàng trai tốt không? Lý do tôi hỏi là vì ai đó
                                        kể với tôi rằng người ta nói điều này với tất cả những con chó, ngay cả khi chúng không ngoan...
                                    </div>
